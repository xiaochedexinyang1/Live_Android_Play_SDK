...
public class PcLivePortraitViewManager {
    ...
    TextView mTitle;
    @BindView(R.id.tv_portrait_live_announce) //TODO 看看顶部导航栏是不是可以共用的
    ...
    @OnClick({
            R.id.tv_portrait_live_announce,
            R.id.iv_portrait_live_change_line,
            R.id.iv_portrait_live_barrage,
            R.id.iv_portrait_live_close,
            R.id.iv_portrait_live_change_audio_video,
            R.id.iv_portrait_live_rtc,
    })
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_portrait_live_announce:
                showAnnounce();
                break;
            case R.id.iv_portrait_live_change_line:
                showSourcePopupWindow();
                break;
            case R.id.iv_portrait_live_barrage:
                changeBarrageStatus();
                break;
            case R.id.iv_portrait_live_close:
                if (mContext instanceof PcLivePlayActivity) {
                    ((PcLivePlayActivity) mContext).showClosePopupWindow();
                }
                break;
            case R.id.iv_portrait_live_change_audio_video:
                changeVideoAudioStatus();
                break;
            case R.id.iv_portrait_live_rtc:
                showRtcPopup();
                break;
        }
    }
